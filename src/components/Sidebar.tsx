...
import { Home, MessageCircle, BookOpen, ArrowLeft, Heart, Timer as TimerIcon, FileText as TestIcon } from 'lucide-react';
...
const navigationItems = [
  { id: 'home', label: 'Início', icon: Home }, // Translated "Home"
  { id: 'chat', label: 'Chat', icon: MessageCircle },
  { id: 'study-tools', label: 'Ferramentas de Estudo', icon: BookOpen }, // Translated "Study Tools"
  { id: 'tests', label: 'Testes', icon: TestIcon }, // Translated "Tests"
];
    ...
    <div className="w-64 bg-white/80 backdrop-blur-sm shadow-xl border-r border-white/20 flex flex-col">
        ...
        {navigationItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              <span className="font-medium">{item.label}</span> {/* Uses translated label */}
            </Button>
          );
        })}
      </nav>
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-3 rounded-lg shadow">
            <div className="flex items-center justify-center gap-2 mb-1">
              ...
              <span className={`font-semibold ${isPomodoroBreak ? 'text-blue-700' : 'text-green-700'}`}>
                {isPomodoroBreak ? 'Tempo de Pausa' : 'Tempo de Foco'} {/* Translated */}
              </span>
            </div>
      ...
      <div className="p-4 border-t border-gray-200/50">
        ...
        >
          ...
          <span className="font-medium">Voltar ao Painel</span> {/* Translated */}
        </Button>
      </div>
    </div>
  );
